...
Having the dataset in the desired format we can proceed to the feature extraction.
...
The whole file is approximately 2GB in size.

With having feature vectors computed we can carry out evaluation~\ref{sec:evaluation}.
