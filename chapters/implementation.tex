...
In order to evaluate the detector I've implemented an algorithm which computes recall on the IoU values between the
MTCNN detection and the area selected by human.
