...
Rectified linear unit (ReLU) layer applies the following~\ref{eq:relu} activation function to the output of layer.
...
The advantage of ReLU is its efficacy during training and reduced likelihood of vanishing gradient.
