...
The accuracy of the model exceeded that of human with \textbf{99.63\%} on LFW dataset.

Interesting innovation of FaceNet is that the output is a vector representing a position in an euclidean space
(so called embeddings) instead of a number representing identity.
