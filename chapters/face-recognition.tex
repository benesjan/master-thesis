...
\begin{enumerate}
    ...
    Architecture of models used for feature extraction is described in section~\ref{sec:fes-architecture}.
...
\section{Feature Extraction System Architecture}\label{sec:fes-architecture}
...
model training in facial recognition tasks.
