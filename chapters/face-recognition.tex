...
\textit{vanishing gradient}\footnote{See footnote on page~\pageref{foot:vangrad}}.
This problem has been avoided by implementation of \textit{skip connections} which are illustrated in
figure~\ref{fig:ResNet}.

\begin{wrapfigure}{r}{7cm}
    \includegraphics[width=7cm]{images/face-recognition/resnet.eps}\label{fig:ResNet}
    \caption{Canonical form of a residual neural network.\cite{ResNetFig}}
\end{wrapfigure}
