...
\begin{equation}\label{eq:softmax}
    L_1 = -\frac{1}{N} \sum_{i=1}^{N} log \frac{e^{W^T_{y_i} x_{i} + b_{y_i}}}{\sum_{j-1}^{n} e^{W^T_{j} x_{i} + b_{j}}},
\end{equation}
...
This makes the loss insufficient for facial recognition tasks and it's the main reason why the following losses
where invented.
