...
recognition.
On the other hand there is a lot of innovation going on in the design of loss functions which work specifically well
...
Triplet loss~\cite{TripletArticle} is a loss function which can be optimized by minimizing the distance between
