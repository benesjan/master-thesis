...
%    Page numbering specified in the following file to avoid counting from the table of contents
    \input{chapters/introduction.tex}

    \input{chapters/cnn/cnn.tex}

    \input{chapters/face-recognition/face-recognition.tex}

    \input{chapters/losses.tex}

    \input{chapters/arcface.tex}
